...
import data from '../Jsondata/Fundingdata.json';
        ...
        <div className="profileWrapper">
            ...
            <div className="heading">
                <div className="policyName">
                    <div className="name">
                        <div><img alt="logo" src={data?.[count]?.companyImg} /></div>
                        <div><h2>{data?.[count]?.policyName}</h2></div>
                    </div>
                ...
                <div className="yearReturn">
                    <div className="percentReturn"> <h2>{data?.[count]?.yearGrowth}</h2> </div>
                    <div className="oneYearReturn"> <h6> {data?.[count]?.year} Return </h6> </div>
                    <div className="percentReturn"> <h2>{data?.[count]?.yearsGrowth}</h2> </div>
                    <div className="oneYearReturn"> <h6> {data?.[count]?.years} Return </h6> </div>
                </div>
